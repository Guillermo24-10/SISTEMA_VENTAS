    ...
    public partial class FRMProveedor : Form
    {
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rpta = NPersona.Insertar("Proveedor",txtNombre.Text.Trim(), cboTipoDocu.Text, txtNumDocu.Text.Trim(), txtDireccion.Text.Trim(), txtTelefono.Text.Trim(), txtEmail.Text.Trim());
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rpta = NPersona.Actualizar(Convert.ToInt32(txtId.Text),"Proveedor",this.NombreAnt, txtNombre.Text.Trim(), cboTipoDocu.Text, txtNumDocu.Text.Trim(), txtDireccion.Text.Trim(), txtTelefono.Text.Trim(), txtEmail.Text.Trim());
